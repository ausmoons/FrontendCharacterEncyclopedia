...
const CharacterDetail = () => {
    ...
    return (
        <Layout>
            <Head>
                <title>{person.name ? `${person.name} - Star Wars Character Details` : 'Star Wars Character Details'}</title>
...
const CharacterInfo = (({ person }: { person: any }) => (
    <div className="space-y-4">
        ...
        <p className="text-lg">
            <span className="font-semibold text-gray-300">Species:</span> {person.species?.name || 'Unknown'}
        </p>
        <p className="text-lg">
